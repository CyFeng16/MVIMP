...
class AnimeGAN(object):
    def __init__(self, sess, args):
        ...
        self.test_real = tf.placeholder(
            tf.float32, [1, None, None, self.img_ch], name="test_real_A"
        )
        ...
        print(
            "# g_adv_weight,d_adv_weight,con_weight,sty_weight,color_weight : ",
            self.g_adv_weight,
            self.d_adv_weight,
            self.con_weight,
            self.sty_weight,
        ...
        for epoch in range(start_epoch, self.epoch):
            ...
            for idx in range(int(self.dataset_num / self.batch_size)):
                ...
                if epoch < self.init_epoch:
                    ...
                    print(
                        "Epoch: %3d Step: %5d  time: %f s init_v_loss: %.8f  mean_v_loss: %.8f"
                        % (
                            epoch,
                            idx,
