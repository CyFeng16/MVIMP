...
def parse_args():
    ...
    parser.add_argument(
        "--checkpoint_dir",
        type=str,
        default="checkpoint/" + "generator_Shinkai_weight",
        help="Directory name to save the checkpoints",
    )
    parser.add_argument(
        "--test_dir",
        type=str,
        default="dataset/test/t",
        help="Directory name of test photos",
    )
    parser.add_argument(
        "--style_name", type=str, default="Shinkai/t", help="what style you want to get"
    )
    parser.add_argument(
...
def test(
    checkpoint_dir, style_name, test_dir, if_adjust_brightness, img_size=[256, 256]
):
