...
class minDepthFlowProjectionLayer(Function):
    ...
    def forward(ctx, input1, input2, requires_grad):
        ...
        if input1.is_cuda:
            ...
            err = my_lib.minDepthFlowProjectionLayer_gpu_forward(
            ...
            err = my_lib.minDepthFlowProjectionLayer_cpu_forward(
                input1, input2, count, output, fillhole
            )
        if err != 0:
            print(err)
    ...
    def backward(ctx, gradoutput):
        ...
        if input1.is_cuda:
            ...
            err = my_lib.minDepthFlowProjectionLayer_gpu_backward(
            ...
            err = my_lib.minDepthFlowProjectionLayer_cpu_backward(
                input1, input2, count, output, gradoutput, gradinput1, gradinput2
            )
            # print(err)
            if err != 0:
