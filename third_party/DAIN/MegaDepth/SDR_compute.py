...
input_height = 240
input_width = 320
test_data_loader_l = CreateDataLoader_TEST(
    dataset_root, test_list_dir_l, input_height, input_width
)
...
input_height = 320
input_width = 240
test_data_loader_p = CreateDataLoader_TEST(
    dataset_root, test_list_dir_p, input_height, input_width
)
