...
test_data_loader_l = CreateDataLoader(
    dataset_root, test_list_dir_l, input_height, input_width, is_flipped, shuffle
)
...
input_height = 320
input_width = 240
test_data_loader_p = CreateDataLoader(
    dataset_root, test_list_dir_p, input_height, input_width, is_flipped, shuffle
)
